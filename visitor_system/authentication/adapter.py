...
class UniversitySocialAccountAdapter(DefaultSocialAccountAdapter):
    ...
    def populate_user(self, request, sociallogin, data):
        ...
        first_name = (
            data.get('given_name') or data.get('givenName') or data.get('first_name')
        )
        last_name = (
            data.get('family_name') or data.get('surname') or data.get('last_name')
        )
        email = (
            data.get('email') or data.get('mail') or data.get('preferred_username')
        )
